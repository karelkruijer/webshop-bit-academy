...
function createShoppingCartItem(product, hoeveelheid) {
    ...
    const productInfo = `Kleur: ${product.name}, Prijs: €${product.price.toFixed(2)}, Aantal:`;
        ...
        if (winkelmand.hasOwnProperty(productId)) {
            ...
            if (product) {
                ...
                if (existingCartItem) {
                    ...
                    quantityElement.textContent = `Aantal: ${producthoeveelheid}`; // Updated to display quantity properly
                } else {
