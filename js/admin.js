...
if (bestellingen && bestellingen.length > 0) {
    bestellingen.forEach(bestelling => {
        ...
        if (winkelmand && typeof winkelmand === 'object') {
            ...
            productCell.innerHTML = "No products in order";
        }
...
producten.forEach(product => {
    ...
    verwijderButton.addEventListener('click', e => {
